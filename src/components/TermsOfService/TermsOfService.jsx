...
const TermsOfService = () => {
  return (
    <PrivacyWrap>
      ...
      <PrivacyText>
        <SubTitle>App Features and Services:</SubTitle>&nbsp;
      ...
      <PrivacyText>
        <SubTitle>User Accounts and Content:</SubTitle>&nbsp;
        To fully utilize the App&rsquo;s features, you may be required to create a user account. You are responsible for maintaining the confidentiality of your account credentials and any content you submit, including your own cocktail recipes. You retain ownership of your content, but by submitting, you grant the App a non-exclusive, royalty-free license to use, modify, and distribute your content within the App.
      </PrivacyText>

      <PrivacyText>
        <SubTitle>Intellectual Property:</SubTitle>&nbsp;
        All content provided by the Cocktail Creations app, including cocktail recipes, images, and text, are protected by copyright and other intellectual property laws.Users may not reproduce, distribute, or use these materials for commercial purposes without explicit permission from the App&rsquo;s operators.
      </PrivacyText>

      <PrivacyText>
        <SubTitle>User - Generated Content Guidelines:</SubTitle>&nbsp;
      ...
      <PrivacyText>
        <SubTitle>App Updates and Changes:</SubTitle>&nbsp;
      ...
      <PrivacyText>
        <SubTitle>Disclaimer of Liability:</SubTitle>&nbsp;
        While we strive to provide accurate and reliable information, the Drink Master app does not warrant the accuracy, completeness, or reliability of the content provided.Users acknowledge that cocktail recipes involve the use of alcohol and potentially hazardous ingredients and should exercise caution when using the recipes.The App&rsquo;s liability is limited to the extent permitted by applicable law.
      </PrivacyText>
