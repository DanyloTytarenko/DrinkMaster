import{s as i,c as n,N as b,k as x,m as w,j as e,u as F,r as p,a6 as G,a7 as _,A as H,a8 as q,a9 as J}from"./index-ef4c7a4a.js";import{c as K,a as Q,u as X}from"./index.esm-df34f3a2.js";const Y=i(b)`
  display: inline-flex;
  align-items: center;
`,ee=i.svg`
  width: 22px;
...
`,ne=()=>e.jsxs(te,{children:[e.jsx(m,{to:"/drinks",children:"Drinks"}),e.jsx(m,{to:"/add",children:"Add drink"}),e.jsx(m,{to:"/my",children:"My drinks"}),e.jsx(m,{to:"/favorites",children:"Favorites drinks"})]}),re=i.ul`
  display: flex;
  column-gap: 14px;
  `,C=i.li``,y=i.a`
  display: inline-flex;
...
`,D=K().shape({email:Q().required("Email is required").email("This is an ERROR email")}),pe=({message:t})=>e.jsx("div",{style:{color:"#DA1414",fontSize:"12px",lineHeight:"14px",marginTop:"2px",marginBottom:"2px",marginLeft:"24px"},children:t}),ce=()=>e.jsx("div",{style:{color:"#3CBC81",fontSize:"12px",lineHeight:"14px",marginTop:"2px",marginBottom:"2px",marginLeft:"24px"},children:"This is an CORRECT email"}),xe=()=>{const t=F(),[r,o]=p.useState(!1),s=X({initialValues:{email:""},validationSchema:D,onSubmit:(d,g)=>{t(G(d)),o(!1),g.resetForm()}}),c=s.touched.email&&s.errors.email;return e.jsxs(se,{onSubmit:s.handleSubmit,children:[e.jsx(le,{children:"Subscribe up to our newsletter. Be in touch with the latest news and special offers, etc."}),e.jsx(ae,{id:"email",name:"email",type:"email",placeholder:"Enter the email",onChange:d=>{s.handleChange(d),D.isValidSync({email:d.target.value})?o(!0):o(!1)},value:s.values.email,onBlur:s.handleBlur,className:c?"error":r?"valid":""}),c?e.jsx(pe,{message:s.errors.email}):r?e.jsx(ce,{}):null,e.jsx(de,{type:"submit",disabled:c,children:"Subscribe"})]})},he=i.div`
  @media screen and (min-width: 768px) {
    display: flex;
    gap: 153px;
...
`,ue=()=>e.jsxs(he,{children:[e.jsx(ge,{children:"©2023 Drink Master. All rights reserved."}),e.jsxs(me,{children:[e.jsx(M,{to:"/privacy",children:"Privacy Policy"}),e.jsx(M,{to:"/service",children:"Terms of Service"})]})]}),fe=i.footer`
  /* padding-top: 40px;
  padding-bottom: 18px; */
...
`,ii=()=>e.jsx(fe,{children:e.jsxs(be,{children:[e.jsxs(we,{children:[e.jsxs(ve,{children:[e.jsxs(je,{children:[e.jsx(W,{}),e.jsx(oe,{})]}),e.jsx(ne,{})]}),e.jsx(xe,{})]}),e.jsx(ue,{}),e.jsx(ke,{}),e.jsx(Ce,{})]})}),ye=i.nav`
display: inline-flex;
flex-direction: column;
align-items: center;
gap: 16px;
...
`,B=()=>{const t=x(w),r=F();return e.jsx(Fe,{theme:t,children:e.jsx(Le,{onClick:()=>r(_()),theme:t})})},Se=i.div`
  position: relative;
  z-index: 100;
`,ze=i.div`
  display: flex;
...
`,Me=i.div`
  ...
  top: 0;
  left: 10%;
`,Be=i.svg`${({theme:t})=>t==="dark"?` fill: ${n.light};`:`fill: ${n.primaryDark};`}`,h="/DrinkMaster/assets/sprite-062e31f9.svg",Ee=({isOpen:t,toggleMenu:r})=>{const o=x(w);return e.jsxs(Se,{children:[t===!1?e.jsxs(ze,{onClick:r,children:[e.jsx(u,{theme:o}),e.jsx(u,{theme:o}),e.jsx(u,{theme:o}),e.jsx(u,{theme:o})]}):e.jsx(Be,{width:"24px",height:"24px",theme:o,onClick:r,children:e.jsx("use",{href:`${h}#icon-close`})}),e.jsxs(De,{open:t,theme:o,children:[e.jsx(Me,{}),e.jsx(a,{to:"/home",onClick:r,children:"Home"}),e.jsx(a,{to:"/drinks",onClick:r,children:"Drinks"}),e.jsx(a,{to:"/add",onClick:r,children:"Add drink"}),e.jsx(a,{to:"/my",onClick:r,children:"My drinks"}),e.jsx(a,{to:"/favorites",onClick:r,children:"Favorites"})]})]})},Te=i.header`
  padding-top: 20px;
  padding-bottom: 20px;
...
`,f="/DrinkMaster/assets/user-833bcaa2.jpg",Ne=()=>{const t=x(w),r=x(H);return e.jsxs(He,{children:[e.jsx(We,{children:e.jsx(Re,{width:"44",height:"44",src:r.avatar||f,alt:"User avatar",onError:o=>{o.currentTarget.src=f}})}),e.jsx(Ve,{theme:t,children:r.name})]})},Oe=i.div`
  display: none;
  z-index: 100;
  ${({open:t})=>t&&`
display: block;
...
`,Xe=i.input`
  display: none;
`,I=()=>{const[t,r]=p.useState(!1),[o,s]=p.useState(!1),[c,d]=p.useState(!1),g=F(),L=x(H),[R,V]=p.useState(L.name),[N,O]=p.useState(L.avatar),U=()=>{r(!t)},A=()=>{d(!c)},S=()=>{s(!o)},z=()=>{s(!1),d(!1),r(!1)},P=l=>{l.preventDefault();const v=l.target.elements.name.value,k=l.target.elements.avatar.files[0];g(J({name:v,avatar:k}))},Z=l=>{const v=l.target.files[0],k=URL.createObjectURL(v);O(k)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{onClick:U,children:e.jsx(Ne,{})}),e.jsx(Oe,{open:t,children:o?e.jsxs(e.Fragment,{children:[e.jsx(T,{onClick:z,children:e.jsx("svg",{width:"18px",height:"18px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-close`})})}),e.jsx(Ze,{children:"Are you sure you want to log out?"}),e.jsxs(Ae,{children:[e.jsx(E,{type:"button",onClick:()=>g(q()),children:"Log out"}),e.jsx(Pe,{type:"button",onClick:S,children:"Cancel"})]})]}):c?e.jsxs(e.Fragment,{children:[e.jsx(T,{onClick:z,children:e.jsx("svg",{width:"18px",height:"18px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-close`})})}),e.jsxs(Qe,{onSubmit:P,children:[e.jsxs(Ke,{children:[e.jsx(qe,{children:e.jsx("img",{width:"100",height:"100",src:N||f,alt:"User avatar",onError:l=>{l.currentTarget.src=f}})}),e.jsxs(Je,{htmlFor:"avatar",children:[e.jsx("svg",{width:"34px",height:"34px",children:e.jsx("use",{href:`${h}#icon-add`})}),e.jsx(Xe,{type:"file",name:"avatar",id:"avatar",accept:".jpg, .jpeg, .png",onChange:Z})]})]}),e.jsx(_e,{type:"text",name:"name",value:R,onChange:l=>V(l.target.value)}),e.jsx(Ge,{type:"submit",children:"Save changes"})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(Ue,{onClick:A,children:[e.jsx("span",{children:"Edit profile"}),e.jsx("svg",{width:"14px",height:"14px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-edit`})})]}),e.jsx(E,{type:"button",onClick:S,children:"Log out"})]})})]})},ti=()=>{const[t,r]=p.useState(window.innerWidth),o=()=>{r(window.innerWidth)};p.useEffect(()=>(window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}),[]);const[s,c]=p.useState(!1),d=()=>{c(!s)};return e.jsx(Te,{children:e.jsxs(Ie,{children:[e.jsx(W,{}),t>=1440&&e.jsxs(e.Fragment,{children:[e.jsx($e,{}),e.jsx(B,{}),e.jsx(I,{})]}),t<1440&&e.jsxs(e.Fragment,{children:[s?e.jsx(B,{}):e.jsx(I,{}),e.jsx(Ee,{isOpen:s,toggleMenu:d})]})]})})};export{ii as F,ti as H,oe as a};
