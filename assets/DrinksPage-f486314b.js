...
`,qe=()=>{const t=C(nt),e=C(it),a=C(ct),s=C(rt),i=C(me),c=C(he),l=_(),n=A("(min-width:769px)")?9:10;return b.useEffect(()=>{t.length||l(xt())},[t,l]),b.useEffect(()=>{e.length||l(ft())},[l,e]),b.useEffect(()=>{l(mt({searchQuery:i,page:s,limit:n}))},[l,n,s,i]),o.jsxs(o.Fragment,{children:[o.jsx(Bt,{}),o.jsx(Tt,{children:o.jsxs(we,{children:[o.jsx(Ot,{title:"Drinks"}),o.jsx(Re,{}),c?o.jsx(ht,{}):o.jsxs(o.Fragment,{children:[o.jsx(Le,{}),o.jsx(Ne,{totalItems:a.max_page,limit:n})]})]})}),o.jsx(Ft,{})]})};export{qe as default};
