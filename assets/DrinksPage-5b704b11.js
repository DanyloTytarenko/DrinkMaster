...
`,Ue=()=>{const t=w(it),e=w(st),o=w(ct),n=w(rt),s=w(de),c=w(pe),l=Q(),i=V("(min-width:769px)")?9:10;return b.useEffect(()=>{t.length||l(xt())},[t,l]),b.useEffect(()=>{e.length||l(ft())},[l,e]),b.useEffect(()=>{l(ht({searchQuery:s,page:n,limit:i}))},[l,i,n,s]),a.jsxs(a.Fragment,{children:[a.jsx(Mt,{}),a.jsxs(_e,{children:[a.jsx(Lt,{title:"Drinks"}),a.jsx(Re,{}),c?a.jsx(mt,{}):a.jsxs(a.Fragment,{children:[a.jsx(we,{}),a.jsx(Ne,{totalItems:o.max_page,limit:i})]})]}),a.jsx(It,{})]})};export{Ue as default};
