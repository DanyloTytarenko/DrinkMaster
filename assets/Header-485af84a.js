import{s as i,c as n,N as f,k as c,m as w,j as e,u as F,r as l,a6 as G,a7 as _,A as H,a8 as q,a9 as J}from"./index-c11febeb.js";import{c as K,a as Q,u as X}from"./index.esm-1a5f5766.js";const Y=i(f)`
  display: inline-flex;
  align-items: center;
`,ee=i.svg`
  width: 22px;
...
`,ti=()=>e.jsx(fe,{children:e.jsxs(be,{children:[e.jsxs(we,{children:[e.jsxs(ve,{children:[e.jsxs(je,{children:[e.jsx(W,{}),e.jsx(oe,{})]}),e.jsx(ne,{})]}),e.jsx(ce,{})]}),e.jsx(ue,{}),e.jsx(ke,{}),e.jsx(Ce,{})]})}),ye=i.nav`
display: inline-flex;
flex-direction: column;
align-items: center;
gap: 16px;
...
`,E=()=>{const t=c(w),r=F();return e.jsx(Fe,{theme:t,children:e.jsx(Le,{onClick:()=>r(_()),theme:t})})},Se=i.div`
display:flex;
align-items: center;
justify-content: center;
gap: 7px
...
`,b="/DrinkMaster/assets/user-833bcaa2.jpg",Be=()=>{const t=c(w),r=c(H);return e.jsxs(Se,{children:[e.jsx(ze,{children:e.jsx("img",{width:"44",height:"44",src:r.avatar||b,alt:"User avatar",onError:o=>{o.currentTarget.src=b}})}),e.jsx(De,{theme:t,children:r.name})]})},Ee=i.div`
  position: relative;
  z-index: 100;
`,Me=i.div`
  display: flex;
...
`,Ie=i.div`
  ...
  top: 0;
  left: 10%;
`,He=i.svg`${({theme:t})=>t==="dark"?` fill: ${n.light};`:`fill: ${n.primaryDark};`}`,h="/DrinkMaster/assets/sprite-062e31f9.svg",We=({isOpen:t,toggleMenu:r})=>{const o=c(w);return e.jsxs(Ee,{children:[t===!1?e.jsxs(Me,{onClick:r,children:[e.jsx(u,{theme:o}),e.jsx(u,{theme:o}),e.jsx(u,{theme:o}),e.jsx(u,{theme:o})]}):e.jsx(He,{width:"24px",height:"24px",theme:o,onClick:r,children:e.jsx("use",{href:`${h}#icon-close`})}),e.jsxs(Te,{open:t,theme:o,children:[e.jsx(Ie,{}),e.jsx(a,{to:"/home",onClick:r,children:"Home"}),e.jsx(a,{to:"/drinks",onClick:r,children:"Drinks"}),e.jsx(a,{to:"/add",onClick:r,children:"Add drink"}),e.jsx(a,{to:"/my",onClick:r,children:"My drinks"}),e.jsx(a,{to:"/favorites",onClick:r,children:"Favorites"})]})]})},Re=i.header`
  display: flex;
  align-items: center;
...
`,Ke=i.input`
  display: none;
`,I=()=>{const[t,r]=l.useState(!1),[o,s]=l.useState(!1),[x,d]=l.useState(!1),g=F(),L=c(H),[R,V]=l.useState(L.name),[N,O]=l.useState(L.avatar),U=()=>{r(!t)},A=()=>{d(!x)},S=()=>{s(!o)},z=()=>{s(!1),d(!1),r(!1)},P=p=>{p.preventDefault();const v=p.target.elements.name.value,k=p.target.elements.avatar.files[0];g(J({name:v,avatar:k}))},Z=p=>{const v=p.target.files[0],k=URL.createObjectURL(v);O(k)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{onClick:U,children:e.jsx(Be,{})}),e.jsx(Ve,{open:t,children:o?e.jsxs(e.Fragment,{children:[e.jsx(T,{onClick:z,children:e.jsx("svg",{width:"18px",height:"18px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-close`})})}),e.jsx(Ae,{children:"Are you sure you want to log out?"}),e.jsxs(Oe,{children:[e.jsx(M,{type:"button",onClick:()=>g(q()),children:"Log out"}),e.jsx(Ue,{type:"button",onClick:S,children:"Cancel"})]})]}):x?e.jsxs(e.Fragment,{children:[e.jsx(T,{onClick:z,children:e.jsx("svg",{width:"18px",height:"18px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-close`})})}),e.jsxs(Je,{onSubmit:P,children:[e.jsxs(qe,{children:[e.jsx(Ge,{children:e.jsx("img",{width:"100",height:"100",src:N||b,alt:"User avatar",onError:p=>{p.currentTarget.src=b}})}),e.jsxs(_e,{htmlFor:"avatar",children:[e.jsx("svg",{width:"34px",height:"34px",children:e.jsx("use",{href:`${h}#icon-add`})}),e.jsx(Ke,{type:"file",name:"avatar",id:"avatar",accept:".jpg, .jpeg, .png",onChange:Z})]})]}),e.jsx(Ze,{type:"text",name:"name",value:R,onChange:p=>V(p.target.value)}),e.jsx(Pe,{type:"submit",children:"Save changes"})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(Ne,{onClick:A,children:[e.jsx("span",{children:"Edit profile"}),e.jsx("svg",{width:"14px",height:"14px",stroke:"#F3F3F3",children:e.jsx("use",{href:`${h}#icon-edit`})})]}),e.jsx(M,{type:"button",onClick:S,children:"Log out"})]})})]})},ni=()=>{const[t,r]=l.useState(window.innerWidth),o=()=>{r(window.innerWidth)};l.useEffect(()=>(window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}),[]);const[s,x]=l.useState(!1),d=()=>{x(!s)};return e.jsxs(Re,{children:[e.jsx(W,{}),t>=1440&&e.jsxs(e.Fragment,{children:[e.jsx($e,{}),e.jsx(E,{}),e.jsx(I,{})]}),t<1440&&e.jsxs(e.Fragment,{children:[s?e.jsx(E,{}):e.jsx(I,{}),e.jsx(We,{isOpen:s,toggleMenu:d})]})]})};export{Ye as C,ti as F,ni as H,ei as S,oe as a,ii as b};
