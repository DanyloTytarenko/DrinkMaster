import{s as t,c as n,N as w,j as e,u as S,r as c,a6 as _,k as x,m,a7 as q,A as R,a8 as J,a9 as K}from"./index-b95de052.js";import{c as Q,a as X,u as Y}from"./index.esm-68303dfb.js";const ee=t(w)`
  display: inline-flex;
  align-items: center;
`,ie=t.svg`
  width: 22px;
...
`,E=Q().shape({email:X().required("Email is required").email("This is an ERROR email")}),ce=({message:i})=>e.jsx("div",{style:{color:"#DA1414",fontSize:"12px",lineHeight:"14px",marginTop:"2px",marginBottom:"2px",marginLeft:"24px"},children:i}),xe=()=>e.jsx("div",{style:{color:"#3CBC81",fontSize:"12px",lineHeight:"14px",marginTop:"2px",marginBottom:"2px",marginLeft:"24px"},children:"This is an CORRECT email"}),he=()=>{const i=S(),[o,r]=c.useState(!1),s=Y({initialValues:{email:""},validationSchema:E,onSubmit:(l,h)=>{i(_(l)),r(!1),h.resetForm()}}),d=s.touched.email&&s.errors.email;return e.jsxs(ae,{onSubmit:s.handleSubmit,children:[e.jsx(le,{children:"Subscribe up to our newsletter. Be in touch with the latest news and special offers, etc."}),e.jsx(de,{id:"email",name:"email",type:"email",placeholder:"Enter the email",onChange:l=>{s.handleChange(l),E.isValidSync({email:l.target.value})?r(!0):r(!1)},value:s.values.email,onBlur:s.handleBlur,className:d?"error":o?"valid":""}),d?e.jsx(ce,{message:s.errors.email}):o?e.jsx(xe,{}):null,e.jsx(pe,{type:"submit",disabled:d,children:"Subscribe"})]})},ge=t.div`
  z-index:10;
  position:relative;
  @media screen and (min-width: 768px) {
    display: flex;
...
`,oi=()=>e.jsx(we,{children:e.jsxs(fe,{children:[e.jsxs(je,{children:[e.jsxs(ke,{children:[e.jsxs(ve,{children:[e.jsx(V,{theme:"dark"}),e.jsx(se,{})]}),e.jsx(oe,{})]}),e.jsx(he,{})]}),e.jsx(be,{}),e.jsx(Ce,{}),e.jsx(ye,{})]})}),$e=t.nav`
display: inline-flex;
flex-direction: column;
align-items: center;
gap: 16px;
...
`,Fe=()=>{const i=x(m);return e.jsxs($e,{children:[e.jsx(p,{to:"/home",theme:i,children:"Home"}),e.jsx(p,{to:"/drinks",theme:i,children:"Drinks"}),e.jsx(p,{to:"/add",theme:i,children:"Add drink"}),e.jsx(p,{to:"/my",theme:i,children:"My drinks"}),e.jsx(p,{to:"/favorites",theme:i,children:"Favorites"})]})},Se=t.div`
  position: relative;
  width: 40px;
  height: 20px;
  border-radius: 10px;
...
`,T=()=>{const i=x(m),o=S();return e.jsx(Se,{theme:i,children:e.jsx(Le,{onClick:()=>o(q()),theme:i})})},ze=t.div`
  position: relative;
  z-index: 100;
`,De=t.div`
  display: flex;
...
`,Ee=t.div`
  ...
  top: 0;
  left: 10%;
`,Me=t.svg`${({theme:i})=>i==="dark"?` stroke: ${n.light};`:`stroke: ${n.primaryDark};`}`,g="/DrinkMaster/assets/sprite-062e31f9.svg",Te=({isOpen:i,toggleMenu:o})=>{const r=x(m);return e.jsxs(ze,{children:[i===!1?e.jsxs(De,{onClick:o,children:[e.jsx(b,{theme:r}),e.jsx(b,{theme:r}),e.jsx(b,{theme:r}),e.jsx(b,{theme:r})]}):e.jsx(Me,{width:"24px",height:"24px",theme:r,onClick:o,children:e.jsx("use",{href:`${g}#icon-close`})}),e.jsxs(Be,{open:i,theme:r,children:[e.jsx(Ee,{}),e.jsx(p,{to:"/home",onClick:o,children:"Home"}),e.jsx(p,{to:"/drinks",onClick:o,children:"Drinks"}),e.jsx(p,{to:"/add",onClick:o,children:"Add drink"}),e.jsx(p,{to:"/my",onClick:o,children:"My drinks"}),e.jsx(p,{to:"/favorites",onClick:o,children:"Favorites"})]})]})},Ie=t.header`
  display: flex;
  align-items: center;
...
`,f="/DrinkMaster/assets/user-833bcaa2.jpg",Ve=()=>{const i=x(m),o=x(R);return e.jsxs(He,{children:[e.jsx(We,{children:e.jsx("img",{width:"44",height:"44",src:o.avatar||f,alt:"User avatar",onError:r=>{r.currentTarget.src=f}})}),e.jsx(Re,{theme:i,children:o.name})]})},Ne=t.div`
