...
`,Ke=()=>{const t=w(rt),e=w(lt),o=w(dt),n=w(ct),p=w(pe),c=w(ge),s=A(),i=V("(min-width:769px)")?9:10;return m.useEffect(()=>{t.length||s(xt())},[t,s]),m.useEffect(()=>{e.length||s(ft())},[s,e]),m.useEffect(()=>{s(ht({searchQuery:p,page:n,limit:i}))},[s,i,n,p]),a.jsxs(a.Fragment,{children:[a.jsx(It,{}),a.jsx(Rt,{children:a.jsxs(Be,{children:[a.jsx(Nt,{title:"Drinks"}),a.jsx(Re,{}),c?a.jsx(mt,{}):a.jsxs(a.Fragment,{children:[a.jsx(Pe,{}),a.jsx(_e,{totalItems:o.max_page,limit:i})]})]})}),a.jsx(Lt,{})]})};export{Ke as default};
