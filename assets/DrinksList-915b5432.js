...
font-weight: 600;
border:none;
`,So="/DrinkMaster/assets/sprite-4ab4835d.svg",Lo=({drink:o})=>{const e=J(),n=()=>{location.pathname==="/DrinkMaster/my"?e(K(o._id)):location.pathname==="/DrinkMaster/favorites"&&e(Y(o._id))};return t.jsxs(jo,{children:[t.jsx(ko,{src:o.drinkThumb,alt:"Photo of cocktail"}),t.jsxs(wo,{children:[t.jsx(Mo,{children:o.drink}),t.jsx(bo,{children:o.alcoholic})]}),t.jsx(Io,{children:o.desc}),t.jsxs($o,{children:[t.jsx(zo,{to:`/drink/${o._id}`,children:"See more"}),t.jsx(Do,{type:"button",onClick:n,children:t.jsx("svg",{width:"24px",height:"24px",stroke:"#F3F3F3",children:t.jsx("use",{href:`${So}#icon-trash`})})})]})]})},Wo=()=>{let o;return location.pathname==="/DrinkMaster/my"?o=w(q):location.pathname==="/DrinkMaster/favorites"&&(o=w(G)),o.length>0?t.jsx(Co,{children:o.map(e=>t.jsx(Lo,{drink:e},e._id))}):t.jsx(Ao,{severity:"info",variant:"outlined",children:"Your drink list is empty"})};export{Ao as A,Wo as D};
