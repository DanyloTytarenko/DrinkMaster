...
`,Oe=()=>{const t=P(nt),e=P(it),a=P(rt),o=P(st),s=P(ce),c=P(le),l=Q(),i=V("(min-width:769px)")?9:10;return m.useEffect(()=>{t.length||l(ut())},[t,l]),m.useEffect(()=>{e.length||l(xt())},[l,e]),m.useEffect(()=>{l(ft({searchQuery:s,page:o,limit:i}))},[l,i,o,s]),n.jsxs(n.Fragment,{children:[n.jsx(zt,{}),n.jsxs(Se,{children:[n.jsx(je,{children:"DrinksPage"}),n.jsx(Pe,{}),c?n.jsx(ht,{}):n.jsxs(n.Fragment,{children:[n.jsx(he,{}),n.jsx(we,{totalItems:a.max_page,limit:i})]})]}),n.jsx(It,{})]})};export{Oe as default};
