import{n,o as h,r as j,j as e,z,A,B as D,F as C,C as $,D as k,E as R}from"./index-3bd5e235.js";import{S as y}from"./react-select.esm-f14e440a.js";import{s as T,a as E,b as m}from"./selectors-6ace5bbf.js";import{u as O}from"./useDispatch-c31e1ece.js";import{H as _,F as L}from"./Footer-39f6f2c2.js";import"./assertThisInitialized-442eebbc.js";const P=n.div`
  // display: flex;
...
`,ge=n.textarea`
  ...
  border: 1px solid rgba(243, 243, 243, 0.5);
  border-radius: 14px;
`,fe=({onChangeHandler:c,setFieldValue:d})=>{const a=h(m);return e.jsxs(de,{children:[e.jsx(pe,{children:"Recipe Preparation"}),e.jsx(ge,{name:"instructions",placeholder:"Enter the recipe",rows:7,required:!0,value:a.instructions,onChange:o=>{d("instructions",o.target.value),c(o.target.value,o.target.name)}})]})},ue=()=>{const c=O();j.useEffect(()=>{c(z("categories")),c(A("glasses")),c(D("ingredients"))},[c]);const d=h(m),[a,o]=j.useState(!0),f=(s,i)=>{console.log(d),console.log(s),c(k(R))},u=(s,i)=>{const p={...d},r={[i]:s};Object.assign(p,r),c(k(p))};return e.jsx(B,{children:e.jsx(C,{initialValues:d,onSubmit:f,children:({setFieldValue:s})=>e.jsxs($,{children:[e.jsx(K,{isAlcoholic:a,setIsAlcoholic:o,onChangeHandler:u,setFieldValue:s}),e.jsx(ce,{isAlcoholic:a,onChangeHandler:u,setFieldValue:s}),e.jsx(fe,{onChangeHandler:u,setFieldValue:s}),e.jsx(N,{type:"submit",title:"Add",children:"Add"})]})})})},ve=()=>e.jsxs(e.Fragment,{children:[e.jsx(_,{}),e.jsxs(P,{children:[e.jsx(W,{children:"AddDrinkPage"}),e.jsx(ue,{}),e.jsx("div",{children:"Follow us"})]}),e.jsx(L,{})]});export{ve as default};
