...
`,nt={dropdownIndicator:(t,e)=>({...t,transform:e.selectProps.menuIsOpen?"rotate(180deg)":"rotate(0deg)"}),option:(t,e)=>({...t,color:e.isSelected||e.isFocused?n.light:"rgba(243, 243, 243, 0.4)"})},Ie={dropdownIndicator:(t,e)=>({...t,transform:e.selectProps.menuIsOpen?"rotate(180deg)":"rotate(0deg)"}),option:(t,e)=>({...t,color:e.isSelected||e.isFocused?n.primaryDark:"rgba(10, 10, 17, 0.4)"})},ze=()=>{const[t,e]=m.useState(""),o=k(st),a=k(lt),p=k(F),d=o.length!==0?["All categories",...o]:[],h=a.length!==0?[{title:"All ingredients"},...a]:[],r=V(),c=Q("(max-width:767px)");m.useEffect(()=>{c&&r(q(t))},[r,c,t]);const l=(s,v="")=>{switch(s){case"searchQuery":e(v),r(O(1));break;case"category":if(v==="All categories"){r(J(""));return}r(J(v)),r(O(1));break;case"ingredient":if(v==="All ingredients"){r(Z(""));return}r(Z(v)),r(O(1));break}},x=s=>{l("searchQuery",s.target.value.trim())},y=s=>{l("category",s.value)},b=s=>{l("ingredient",s.value)},u=s=>{s.preventDefault(),r(q(t))};return i.jsx($e,{children:i.jsxs(Ce,{onSubmit:u,children:[i.jsxs(Pe,{children:[i.jsx(we,{type:"text",placeholder:"Enter the text",onChange:x,theme:p}),i.jsx(je,{type:"submit",children:i.jsx(Se,{theme:p})})]}),i.jsx(at,{name:"category",placeholder:"All categories",classNamePrefix:"react-select",styles:p==="dark"?nt:Ie,theme:p,noOptionsMessage:()=>"No categories",options:d.map(s=>({label:s,value:s})),onChange:y}),i.jsx(at,{name:"ingredient",styles:nt,theme:p,placeholder:"Ingredients",classNamePrefix:"react-select",noOptionsMessage:()=>"No ingredients",options:h.map(s=>({label:s.title,value:s.title})),onChange:b})]})})},Me=({limit:t,totalItems:e})=>{const o=k(ct),a=k(F),[p,d]=m.useState(1),[h,r]=m.useState(2),c=V(),l=Q("(min-width:768px)"),x=Math.ceil(e/t);m.useEffect(()=>{if(!l&&x>5){d(1),r(0);return}if(l&&x>8){d(3),r(-2);return}d(1),r(2)},[x,l]);const y={stack:{display:"flex",flexDirection:"row",justifyContent:"center",alignItems:"center",width:l?"436px":"320px",height:"55px",marginLeft:"auto",marginRight:"auto"},pagination:{".MuiPaginationItem-root":{marginLeft:"7px",marginRight:"7px",padding:"0",minWidth:"27px",height:"27px",fontSize:"12px",fontWeight:"500",color:`${a==="dark"?n.light:n.primaryDark}`,transition:"background 250ms ease","&:hover":{backgroundColor:`${a==="dark"?"rgba(64, 112, 205, 0.4)":"rgba(64, 112, 205, 0.9)"}`}},".MuiPaginationItem-page.Mui-selected":{backgroundColor:`${a==="dark"?"rgba(64, 112, 205, 0.5)":n.blue}`},"ul.MuiPagination-ul":{flexWrap:"nowrap","& > :first-of-type":{marginRight:"16px"},"& > :last-of-type":{marginLeft:"16px"}}}};return i.jsx(Gt,{sx:y.stack,children:x>1&&i.jsx(pe,{count:x,page:o,boundaryCount:p,siblingCount:h,onChange:(b,u)=>c(O(u)),onClick:()=>window.scrollTo({top:200,behavior:"smooth"}),sx:y.pagination})})},Le=$.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  box-sizing: border-box;
...
`,Ge=()=>{const t=k(st),e=k(lt),o=k(dt),a=k(ct),p=k(ge),d=k(ue),h=k(F),r=V(),l=Q("(min-width:769px)")?9:10;return m.useEffect(()=>{t.length||r(xt())},[t,r]),m.useEffect(()=>{e.length||r(ht())},[r,e]),m.useEffect(()=>{r(ft({searchQuery:p,page:a,limit:l}))},[r,l,a,p]),i.jsxs(i.Fragment,{children:[i.jsx(Lt,{}),i.jsx(Rt,{children:i.jsxs(Le,{children:[i.jsx(Nt,{title:"Drinks",theme:h}),i.jsx(ze,{}),d?i.jsx(mt,{}):i.jsxs(i.Fragment,{children:[i.jsx(ve,{}),i.jsx(Me,{totalItems:o.max_page,limit:l})]})]})}),i.jsx(Dt,{})]})};export{Ge as default};
